...
// GodOrDevil
#ifndef CGAME
extern vmCvar_t nv_mapEditorInput;
#endif
// END
...
// GodOrDevil - 03.22.07 - 06:13pm #mapEditor
#ifndef CGAME
		if(!Q_stricmpn (val, "additemText", 11))
		{	
			DC->executeText(EXEC_APPEND, va("additem %s %s; ", item->window.name, nv_mapEditorInput.string));
			DC->setCVar("nv_mapEditorInput", "");
			return;
		}
#endif
// End - 03.22.07 - 06:13pm
...
void Tooltip_Paint ( itemDef_t *item )
{
	...
	//Ryan May 5 2004,  I'll do the TODO above
	x2 = x + w + 10;
	y2 = y + h + 10;
