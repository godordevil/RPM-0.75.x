...
extern vmCvar_t ui_admPunishCmd;
extern vmCvar_t ui_clientKickReason;
extern vmCvar_t ui_authMessage;
extern vmCvar_t	ui_songCount;
extern vmCvar_t ui_voteIndex;
//extern vmCvar_t	ui_musicFolder;
