...
//#define _MAPEDITOR
//#endif
//current punishment count (-1 since 0 is recognized)
...
//Ryan march 7 2004 8:31pm
#define MAX_SONGS				256
//Ryan

// GodOrDevil
#define	MAX_MODEL_LIST			550
// END
...
typedef struct 
{
	...
	//Ryan march 7 2004 8:06pm
	const char*		songList[MAX_SONGS];
	int				songCount;
	int				songIndex;
	//Ryan

	// GodOrDevil
	const char *bspList[MAX_MOVIES];
	int bspCount;
	int bspIndex;
	
	const char *modelList[MAX_MODEL_LIST];
	int modelCount;
	int modelIndex;
