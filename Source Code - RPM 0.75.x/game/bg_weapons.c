...
// GodOrDevil - 03.02.05 - 05:16pm #Tokens
//// Moddified from Ryans original Code
//// Ryan Nov19 2004
//// Short names for each weapon for use with the chat tokens

char *rpm_weaponLongNames[WP_NUM_WEAPONS] = 
{
	"No Weapon",					// WP_NONE,
	"Knife",						// WP_KNIFE,
	"M19 PISTOL ",			    	// WP_M1911A1_PISTOL,
	"US SOCOM",						// WP_USSOCOM_PISTOL,
	"Shotgun",						// WP_M590_SHOTGUN,
	"Micro Uzi",					// WP_MICRO_UZI_SUBMACHINEGUN,
	"Submachine Gun",				// WP_M3A1_SUBMACHINEGUN,
	"Auto-Shotgun",					// WP_USAS_12_SHOTGUN,
	"M4 Assault Rifle",				// WP_M4_ASSAULT_RIFLE,
	"AK74 Assault Rifle",			// WP_AK74_ASSAULT_RIFLE,
	"Sniper Rifle",					// WP_MSG90A1_SNIPER_RIFLE,
	"M60 Machinegun",				// WP_M60_MACHINEGUN,
	"Grenade Launcher",				// WP_MM1_GRENADE_LAUNCHER,
	"Rocket Launcher",				// WP_RPG7_LAUNCHER,
	"M67 Grenade",					// WP_M67_GRENADE,
	"Flash Grenade",				// WP_M84_GRENADE,
	"F1 Frag Grenade",				// WP_F1_GRENADE,
	"L2A2 Grenade",					// WP_L2A2_GRENADE,
	"MDN11 Grenade",				// WP_MDN11_GRENADE,
	"SMOGH92 Frag Grenade",			// WP_SMOHG92_GRENADE,
	"Fire Grenade", 				// WP_ANM14_GRENADE,
	"Smoke Grenade",				// WP_M15_GRENADE,
};
//End - 03.02.05 - 05:16pm 
...
qboolean BG_InitWeaponStats(void)
{
	...
	int			i;
#ifdef QAGAME
	// GodOrDevil - 04.28.06 - 05:00am #weaponMod
	GP2 = trap_GP_ParseFile(va("ext_data/%s.wpn", g_weaponModFile.string), qtrue, qfalse);	
	if(!GP2)
	///End  - 04.28.06 - 05:10am
#endif
