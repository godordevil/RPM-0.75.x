...
//Ryan april 15 2003
#include "rpm_public.h"
//Ryan

// GodOrDevil - 11.28.05 - 02:57pm #includes
#ifdef QAGAME
extern vmCvar_t	g_weaponModFile;
#endif
///End  - 11.28.05 - 02:57pm
...
// GodOrDevil - 04.06.07 - 09:35pm #mapEditor
#ifdef _MAPEDITOR
#define PMF_MAPEDITOR			0x02000000		// Lets zoomin/out buttons work when not zoomed
#endif
///End  - 04.06.07 - 09:33pm
...
#ifdef _WeaponTime
extern vmCvar_t g_weapontime;   // GodOrDevil - 02.04.05 - 05:57am #weaponTime
#endif
...
typedef enum 
{
	...
	STAT_USETYPE,					// used for client types (NV specific);
	
	STAT_REALARMOR,					// used for client types (NV specific);
