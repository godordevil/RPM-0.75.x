...
vec4_t		colorGreen	= {169.0f/255.0f, 194.0f/255.0f, 116.0f/255.0f, 1.0}; // {0, 1, 0, 1};
...
//	{0.0, 1.0, 0.0, 1.0},		// Green
	{169.0f/255.0f, 194.0f/255.0f, 116.0f/255.0f, 1.0},		// Green
...
Tests to see if the given ray intersects the given sphere
================
*/
...
#ifdef __cplusplus
	int		randIndex;
	float	randTable[RAND_TABLE_SIZE];
#endif
...
#ifdef Q3_VM // GodOrDevil - DLL stfu Fix for MSVC
