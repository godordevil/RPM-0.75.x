...
// Ryan		Here is where we adjust the RPM mod version for both server and client
// GodOrDevil - Changed #Version
#define RPM_VERSION 0.7f
#define RPM_VERSION_STRING "0.75"
#define RPM_VERSION_STRING_LONG "RPM 0.7"
#define RPM_VERSION_STRING_COLORED "^$R^3P^4M ^70.75"
#define RPM_VERSION_DATE __DATE__



#ifndef _ENABLE_EXTRAS

	#define _ENABLE_EXTRAS			// Enables all this shit :P
	#define _KILLSPREE				// Killing spree rewards
	#define _NEW_MAP_SETUP			// Random map voting, map settings, etc..
	#define _NUMBERED_BOT_NAMES		// Append a number to a bot.
	#define _NV_ADMIN				// Using NV Mod admin command setup 
	#define _ALTVOTEMAP				// Alternate random voted maps setup
	#define _MAPVOTE_MOST			// Mark voting counts for nextmap /  Name increment
	#define _PISTOLDROPPED			// So that the faggoty ass pistol droppers who cant manage more then 2 weapons dont clutter the ground.
	#define _MANDOWN_HITBOX			// Uses the HITBOX from mandown AND standard RPM style.  Thought abut removing it, so I defined it incase I do.
	#define _CLEAR_DROPPED			// Clear dropped items incase we are close to the limit and have a lot of dropped weapons/thrown knives laying around.
	#define _STUPID_SHIT			// Removing shit that we dont really care about.  Mostly friend MOTD, TK message, and warmup checks.
	#define _CHAT_KEYWORDS			// Keywords that get a response if typed in chat.
	
	//#define _SPECIAL_NADES		// Custom grenades.. gas, airstrike, etc..
	//#define _RECRUITER			// Replace 'referee' with 'recruiter' status -- needs testing.  Admin level 5.   Recruiter > S-ADMIN
	//#define _CLANMEMBER			// Removed CLAN MEMBER shit
	//#define _BADMIN_FILE			// Store B-Admin's in a seperate list
	//#define _COMPMODE				// Enable RPM Compmode shit thats dumb as fuck.

	#ifdef _DEBUG					// For Work In Progress / testing shit out
		//#define _DB_STATS_DLL		// DLL Database - stand alone
		//#define _DB_QVM				// QVM Database - With external hook/dll
		#define _FORT				// Base assault gametype.
		#define _DCTF				// Dynamic ctf gametype.  
		#define _OVERPOWER			// OverPOWER gametype. 
		#define _ZOMBIES			// Another Zombies type game.  
		#define _FAIR_WEAPON_STATS	// Enabling/forcing extra weapons wont count towards stats.
		#define _DB_WEBCMDS			// Handles commands from website.
		#define _EFFECTS			// Testing different effects.
	//	#define _BOT_STRESS			// Bot adding/removing in bulk for various things
		#define _CRS_BOTS
	//	#define _SOF2_BOTS	
	#endif

#ifdef _DB_STATS_DLL				// QVM Database - With external hook/dll
	#define _DB_ENABLED			
#endif
#ifdef _DB_QVM				// QVM Database - With external hook/dll
	#define _DB_ENABLED			
#endif

	#ifdef _CRS_BOTS
		#define _SOF2_BOTS			// Always enable bots if CRS bots are enabled
	#endif
...
/*
#define RPM_VERSION 0.6
#define RPM_VERSION_STRING "0.6"
#define RPM_VERSION_STRING_LONG "RPM 0.6"
#define RPM_VERSION_DATE "12/21/2004"
*/
//End
// Ryan
...
// GodOrDevil -- DLL stfu FIX for msvc compiler
#ifdef Q3_VM
...
#define CADM_CHAT   10
/// - GodOrDevil
#define	AW_CHAT		11	//Admin Warning
#define	AI_CHAT		12	//AdminInfo
#define	AR_CHAT		13	//AdminRule
#define	AN_CHAT		14	//AdminNothing
#define	AS_CHAT		15	//AdminSlient
///
//Ryan

// GodOrDevil - 03.27.05 - 01:38pm #PlayChat
//#define PLAY_CHAT    10
//End  - 03.27.05 - 01:39pm
